...
class active_client extends Controller
{
    ...
    public function show($id)
    {
        ...
        $applicants = Applicant::where('client_id', "$id")->get();
        $appJobs = JobOrder::where('client_id', $id)->withCount(['applicant','lined_up', 'signed_jol'])->get();
        ...
        // echo $posts[0]->status_count;
        return view('Client.client_jobsite', compact('clientData', 'countJobOrder', 'JobOrder', 'medical', 'visa', 'OEC', 'linedup', 'total', 'appcount', 'getposition', 'applicants', 'appJobs'));
